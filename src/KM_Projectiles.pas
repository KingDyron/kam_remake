...
const
  ...
  PROJECTILE_JITTER: array[TKMProjectileType] of Single = (0.26, 0.29, 0.26, 0.2, 0.9, 0.19); //Fixed Jitter added every time
  PROJECTILE_JITTER_HOUSE: array[TKMProjectileType] of Single = (0.6, 0.6, 0.6, 0, 1.8, 0.4); //Fixed Jitter added every time
